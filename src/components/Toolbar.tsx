...
export function Toolbar({ filename, canvasRef, onReset, onNewImage }: ToolbarProps) {
  ...
  return (
    <div className="flex items-center gap-2 px-3 py-2.5 border-b border-zinc-700">
      <span className="flex-1 text-xs text-zinc-400 truncate" title={filename}>{filename}</span>
      <button
        onClick={openPicker}
